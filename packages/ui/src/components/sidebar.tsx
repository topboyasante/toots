...
function SidebarGroupLabel({
  ...
  if (asChild) {
    return <Slot.Root {...(labelProps as React.ComponentProps<typeof Slot.Root>)} />
  }
...
function SidebarGroupAction({
  ...
  if (asChild) {
    return <Slot.Root {...(actionProps as React.ComponentProps<typeof Slot.Root>)} />
  }
  return <button {...actionProps} />
}
...
function SidebarMenuButton({
  ...
  const button = asChild ? (
    <Slot.Root {...(buttonProps as React.ComponentProps<typeof Slot.Root>)} />
  ) : (
    <button {...buttonProps} />
  )
...
function SidebarMenuSubButton({
  ...
  if (asChild) {
    return <Slot.Root {...(subButtonProps as React.ComponentProps<typeof Slot.Root>)} />
  }
